            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Sign Up Tutorna</h3>
                    </div>
							...
							<div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
								 ...
								 <div class="form-group">
                                    <input class="form-control" placeholder="Re Enter Password" name="pword2" type="password" value="" required>
                                </div>
								...
								<div>Already have an account <a href="logintutorna.php">sign In here</a></div>
                            </fieldset>
                        </form>
                    </div>
                </div>
